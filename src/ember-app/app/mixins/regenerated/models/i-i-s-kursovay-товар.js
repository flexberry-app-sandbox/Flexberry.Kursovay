...
export let Model = Mixin.create({
  ...
  записьВНакладной: DS.belongsTo('i-i-s-kursovay-запись-в-накладной', { inverse: null, async: false }),
  строкаЗаказа: DS.belongsTo('i-i-s-kursovay-строка-заказа', { inverse: null, async: false }),
  товарНаСкладе: DS.belongsTo('i-i-s-kursovay-товар-на-складе', { inverse: null, async: false })
});
