...
namespace IIS.Kursovay
{
    ...
    public class СтрокаЗаказа : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kursovay.Заказ fЗаказ;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Kursovay.Заказ.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Заказ"})]
        public virtual IIS.Kursovay.Заказ Заказ
        {
            get
            {
                ...
                IIS.Kursovay.Заказ result = this.fЗаказ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СтрокаЗаказаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СтрокаЗаказаE", typeof(IIS.Kursovay.СтрокаЗаказа));
                }
            }
        }
    }
    ...
    public class DetailArrayOfСтрокаЗаказа : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Kursovay.DetailArrayOfСтрокаЗаказа members)

        // *** End programmer edit section *** (IIS.Kursovay.DetailArrayOfСтрокаЗаказа members)
        ...
        /// </summary>
        public DetailArrayOfСтрокаЗаказа(IIS.Kursovay.Заказ fЗаказ) : 
                base(typeof(СтрокаЗаказа), ((ICSSoft.STORMNET.DataObject)(fЗаказ)))
        {
        }
        
        public IIS.Kursovay.СтрокаЗаказа this[int index]
        {
            get
            {
                return ((IIS.Kursovay.СтрокаЗаказа)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Kursovay.СтрокаЗаказа dataobject)
        {
