...
namespace IIS.Kursovay
{
    ...
    [View("ЗаказL", new string[] {
            ...
            "ДатаОтгрузки as \'Дата отгрузки\'",
            "Статус as \'Статус\'"})]
    public class Заказ : IIS.Kursovay.Документ
    {
        ...
        public virtual IIS.Kursovay.DetailArrayOfСтрокаЗаказа СтрокаЗаказа
        {
            get
            {
                ...
                {
                    this.fСтрокаЗаказа = new IIS.Kursovay.DetailArrayOfСтрокаЗаказа(this);
                }
                IIS.Kursovay.DetailArrayOfСтрокаЗаказа result = this.fСтрокаЗаказа;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказE", typeof(IIS.Kursovay.Заказ));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаказL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказL", typeof(IIS.Kursovay.Заказ));
                }
            }
        }
    }
