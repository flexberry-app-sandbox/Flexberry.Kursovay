...
namespace IIS.Kursovay
{
    ...
    public class Склад : ICSSoft.STORMNET.DataObject
    {
        ...
        public virtual IIS.Kursovay.DetailArrayOfТоварНаСкладе ТоварНаСкладе
        {
            get
            {
                ...
                {
                    this.fТоварНаСкладе = new IIS.Kursovay.DetailArrayOfТоварНаСкладе(this);
                }
                IIS.Kursovay.DetailArrayOfТоварНаСкладе result = this.fТоварНаСкладе;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СкладE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СкладE", typeof(IIS.Kursovay.Склад));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СкладL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СкладL", typeof(IIS.Kursovay.Склад));
                }
            }
        }
    }
