...
namespace IIS.Kursovay
{
    ...
    public class Товар : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kursovay.ЗаписьВНакладной fЗаписьВНакладной;
        
        private IIS.Kursovay.СтрокаЗаказа fСтрокаЗаказа;
        
        private IIS.Kursovay.ТоварНаСкладе fТоварНаСкладе;
        ...
        [PropertyStorage(new string[] {
                "ЗаписьВНакладной"})]
        [NotNull()]
        public virtual IIS.Kursovay.ЗаписьВНакладной ЗаписьВНакладной
        {
            get
            {
                ...
                IIS.Kursovay.ЗаписьВНакладной result = this.fЗаписьВНакладной;
        ...
        [PropertyStorage(new string[] {
                "СтрокаЗаказа"})]
        [NotNull()]
        public virtual IIS.Kursovay.СтрокаЗаказа СтрокаЗаказа
        {
            get
            {
                ...
                IIS.Kursovay.СтрокаЗаказа result = this.fСтрокаЗаказа;
        ...
        [PropertyStorage(new string[] {
                "ТоварНаСкладе"})]
        [NotNull()]
        public virtual IIS.Kursovay.ТоварНаСкладе ТоварНаСкладе
        {
            get
            {
                ...
                IIS.Kursovay.ТоварНаСкладе result = this.fТоварНаСкладе;
